...
614
mods
foreach seq 0.5 0.99 0.01 [\n  [w]-> show (word w \" -> \" network-modularity w)\n]
NIL
1
T
OBSERVER
...
<experiments>
  ...
  <experiment name="grid_mu_theta" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <final>;dump-voc-network (word "_final" ticks)</final>
    <timeLimit steps="10000"/>
    <metric>count turtles</metric>
    <metric>max-network-modularity</metric>
    <enumeratedValueSet variable="memory-impedance">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="wandering-radius">
